...
def test_user(client):
    user_data = json={'email':'ayoube@gmail.com',
...
def test_user2(client):
    user_data = json={'email':'ayoube1@gmail.com',
...
def test_posts(test_user,test_user2,session):
    ...
    session.add_all(
        ...
        models.Post(title='seconde title',content='second content',owner_id=test_user['id']),
